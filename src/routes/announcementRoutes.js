...
const presidentMiddleware = require('../middlewares/presidentMiddleware');
const secretaryMiddleware = require('../middlewares/secretaryMiddleware');
const treasurerMiddleware = require('../middlewares/treasurerMiddleware');
const {
    createAnnouncement,
